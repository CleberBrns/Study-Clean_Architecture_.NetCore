...
namespace CleanArchMvc.Infra.Data.Identity
{
    public class SeedUserRoleInitial : ISeedUserRoleInitial
    {
        ...
        {
            if (_userManager.FindByEmailAsync("usuario@localhost").Result != null) return;
            {
            ...
            if (_userManager.FindByEmailAsync("admin@localhost").Result != null) return;
            {
                var user = new ApplicationUser
                {
        ...
        public void SeedRoles()
        {
            ...
            if (_roleManager.RoleExistsAsync("Admin").Result) return;
            {
                var role = new IdentityRole
                {
                    Name = "Admin",
